...
sampling. In fact, an attempt at drawing a "diverse" set of images results in 
...
Based on work by \citet{wang2018data} and \citet{kaushal2019learning}, future
work may involve an active learning based approach using iterative 
