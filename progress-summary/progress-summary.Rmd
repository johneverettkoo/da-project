...
```{r mnist_val_constrained, fig.cap = 'Diversity on MNIST data, using the "validation from training" sampling method.'}
...
```{r cifar10_val_constrained, fig.cap = 'Diversity on CIFAR-10 data, using the "validation from training" sampling method.'}
...
\citep{Ferreira2016UnsupervisedES} proposed a maximum entropy based sampling 
method for selecting training data. 

\citep{Wilson1972AsymptoticPO} demonstrated that edited $k$-nearest neighbors 
